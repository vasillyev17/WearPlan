...
namespace WP.Controllers
{
    public class PurchaseController : Controller
    {
        ...
        public PurchaseController(wpContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("idPurchase,idProduct,idCustomer")] Purchase purchase)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idPurchase,idProduct,idCustomer")] Purchase purchase)
        {
